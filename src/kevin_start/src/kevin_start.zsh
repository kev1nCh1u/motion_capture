...
sleep 0.2
gnome-terminal --tab -t "camera" -- sh -ic "python src/dahua_python/src/ros_cv_getFrame.py"
sleep 0.2
gnome-terminal --tab -t "camera" -- sh -ic "python src/dahua_python/src/ros_cv_getFrame.py -c 1"
sleep 0.2
