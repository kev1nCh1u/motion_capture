...
sleep 0.2
gnome-terminal --tab -t "camera_0" -- sh -ic "python src/dahua_python/src/ros_cv_getFrame.py -c 0"
sleep 0.2
gnome-terminal --tab -t "camera_1" -- sh -ic "python src/dahua_python/src/ros_cv_getFrame.py -c 1"
sleep 0.2
