...
# point = point[600:]
print("size:",len(point))
print("point0:",point[0,:])
point = point[(point[:,8] < 3)]

print("x_min:",np.min(point[:,1]))
print("x_max:",np.max(point[:,1]))
print("y_min",np.min(point[:,2]))
print("y_max",np.max(point[:,2]))
print("z_min",np.min(point[:,3]))
print("z_max",np.max(point[:,3]))
print("r_min",np.min(point[:,4]))
print("r_max",np.max(point[:,4]))
print("p_min",np.min(point[:,5]))
print("p_max",np.max(point[:,5]))
print("y_min",np.min(point[:,6]))
print("y_max",np.max(point[:,6]))
print("rmse_min",np.min(point[:,8]))
print("rmse_max",np.max(point[:,8]))
